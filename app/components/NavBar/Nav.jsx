      ...
      <div className="flex flex-wrap items-center justify-between max-w-screen-2xl px-4 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
          ...
          <Link
            ...
            className="text-white bg-[#E3311D] hover:bg-[#383838] focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800"
          >
            Log In
          </Link>
          <button
