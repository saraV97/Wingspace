...
const Features = () => {
  return (
    <section className="mt-2 md:mt-10 mb-2 md:mb-10" id="features">
      <div className="px-4 py-24 mx-auto md:px-12 lg:px-40 max-w-screen-2xl flex flex-col lg:h-svh justify-center">
          ...
          <div className="mt-6 border-t pt-12">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-24 items-center ">
              ...
              <div className="h-full md:order-first ">
                {" "}
                <Image
                  src="https://www.rapinteriors.co.uk/wp-content/uploads/2019/05/an-office-with-shared-furniture-solutions-an-an-orange-walls.jpg.webp"
                  alt="#_"
                  width={60}
                  height={60}
                  className=" bg-gray-200 shadow-box rounded-2xl shadow-gray-500/30 overflow-hidden aspect-square w-[35rem] h-80 object-cover object-center"
                />{" "}
              </div>
            </div>
